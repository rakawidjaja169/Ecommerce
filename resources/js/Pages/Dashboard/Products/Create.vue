...
const createProduct = () => {
    Inertia.patch(route("settings.profile.update"), { name: form.name }, {
...
<template>
    <DashboardLayout>
        ...
        <header class="mb-8">
            <h2 class="font-medium uppercase text-2xl">Add Product</h2>            
        </header>
        ...
        <form @submit.prevent="createProduct()">
            ...
            <button
                ...
                class="text-white text-xxs py-2 w-24 rounded transition flex justify-center mt-6"
            >
                <span class="uppercase" v-if="!form.processing">Add</span>
